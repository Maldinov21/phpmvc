                      ...
                      <tbody>
                          ...
                          <?php foreach ($data['user'] as $row) : ?>
                              <tr>
                                  ...
                                  <td><?= $row['username']; ?></td>
                                  <td>
                                      <a href="<?= BASEURL; ?>/user/edit/<?= $row['id'] ?>" class="badge badge-info ">Edit</a> <a href="<?= BASEURL; ?>/user/hapus/<?= $row['id'] ?>" class="badge badge-danger" onclick="return confirm('Hapus data?');">Hapus</a>
                                  </td>
                              </tr>
                          <?php $no++;
                            endforeach; ?>
